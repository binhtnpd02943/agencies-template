export default {
	...
	darkMode: 'media', // Or simply remove this line as 'media' is the default
	theme: {
		fontFamily: {
		...
		extend: {
			backgroundImage: {
				'small-shadow': 'linear-gradient(to top, rgba(0, 0, 0, 0.5) 0%, transparent 100%)',
			},
			borderWidth: {
				6: '6px',
				10: '10px',
			...
			colors: {
				...
				danger: '#D34053',
				warning: '#FFA70B',
				'custom-yellow': 'rgb(252, 227, 138)',
				'custom-red': 'rgb(243, 129, 129)',
				'custom-gradient': 'linear-gradient(to right, rgb(252, 227, 138) 0%, rgb(243, 129, 129) 100%)',
			},
			fontSize: {
				'title-xxl': ['44px', '55px'],
